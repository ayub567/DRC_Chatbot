...
export const buildInPrompt = {
  ...
  review: {
    ...
    user: (
      text: string,
      language: string
    ) => `I want you to act as a check and evaluate professional research protocol.Title Alignment:
Does the title accurately reflect the content and scope of the research?
Is the title concise, informative, and relevant to the intended audience?
Does the title capture the essence of the research problem or the central theme of the study?
Research Questions:
Are the research questions clearly articulated and logically derived from the study's purpose or problem statement?
Do the research questions address gaps in knowledge or contribute to advancing the field?
Are the research questions realistic and feasible given the resources and constraints of the study?
Objectives:
Do the objectives of the study directly align with the research questions and overarching goal of the research?
Are the objectives stated in a way that allows for clear evaluation of their attainment?
...
Do the hypotheses make predictions about the relationship between variables or expected outcomes?
Are the hypotheses grounded in theory or previous empirical evidence?
Alignment and Coherence:
Is there consistency and coherence between the title, research questions, objectives, and, if applicable, hypotheses?
Do all elements of the research protocol work together to provide a clear roadmap for the study?
Are there any discrepancies or disconnects between different components of the protocol that need to be addressed?
Rationale:
